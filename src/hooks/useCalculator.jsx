...
//     setDisplay((prev) => {
//       if (operator) {
//         const lastNum = prev.split(operator).pop();
//         const bigValue = new Big(lastNum);
//         const percentage = bigValue.div(100).toString();
//         const newDisplay = prev.slice(0, -lastNum.length) + percentage;
//         return newDisplay;
//       } else {
//         const bigValue = new Big(prev);
//         return bigValue.div(100).toString();
